...
"AIDS", "BZR", "COLLAB", "COX2", "DD", "DHFR", "ENZYMES", "IMDB-BINARY", "IMDB-MULTI", "MUTAG", "NCI1", "PROTEINS", "PTC_MR", "hERG", "ogbg-molhiv", "ogbg-molpca", "ogbg-ppa", "ogbg-code2", "NOMAD_FGL", "PUBCHEM_FGL"]
...
"Amazon-ratings", "Roman-empire", "Questions", "Minesweeper", "Reddit", "Flickr", "ACM"]
...
supported_fl_algorithm = ["isolate", "fedavg", "fedprox", "scaffold", "moon", "feddc", "fedproto", "fedtgp", "fedpub", "fedstar", "fedgta", "fedtad", "gcfl", "gcfl_plus", "optgdba", "fedgmark", "nigdba", "fedsage_plus", "adafgl", "feddep", "fggp", "fgssl", "fedgl", "feroma", "fedexp", "fedlaw", "fedala", "fedluar", "pfed1bs", "tinyproto", "fedspa", "fedgcn_ori", "fedgcn_our", "fedstruct", "fediih", "s2fgl", "fedspray", "cufl", "fedgraph", "spp_fgc", "fedlpa", "fedppn", "fedrgl", "hifgl", "fedhgn", "fedhgnn", "fedlit", "fedda", "fedvn", "fedlog", "fedssp"]


supported_metrics = ["accuracy", "precision", "f1", "recall", "auc", "ap", "clustering_accuracy", "nmi", "ari", "mae", "rmse", "mse"]

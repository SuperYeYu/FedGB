...
from fedgb.algorithms.subgraph_fgl.homogeneous.fedpub.fedpub_config import config
from fedgb.algorithms.subgraph_fgl.homogeneous.fedpub.maskedgcn import MaskedGCN

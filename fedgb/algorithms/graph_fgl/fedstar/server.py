...
from fedgb.algorithms.graph_fgl.fedstar.gin_dc import serverGIN_dc,DecoupledGIN
from fedgb.algorithms.graph_fgl.fedstar.fedstar_config import config
from fedgb.algorithms.graph_fgl.fedstar.client import resolve_fedstar_config
...
class FedStarServer(BaseServer):
    ...
    def __init__(self, args, global_data, data_dir, message_pool, device):
        ...
        self.task.load_custom_model(serverGIN_dc(n_se=n_se,
